...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mazureq.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("poczta.mazur@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("11235813Q");
        ...
        result = driverTrello.findElements(By.xpath("//a[contains(@class, \"list-card\")]")).stream()
    ...
    @Test
    public void shoulCreateTrelloCard() throws InterruptedException {
